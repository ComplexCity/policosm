...
def simplify_directed_as_dataframe(df):
    ...
    for i, candidate in enumerate(candidates):
        ...
        if is_u_fringe and is_w_fringe:
            ...
            osm_id[e], highway[e], level[e], lanes[e], width[e], bicycle[e], bicycle_safety[e], foot[e], foot_safety[e], \
                max_speed[e], motorcar[e] = osm_id[cw], highway[cw], level[cw], lanes[cw], width[cw], bicycle[cw], bicycle_safety[cw], \
            ...
            e_linestring[e] = [int(nodes_id[node]) for node in path]
            osm_id[e], highway[e], level[e], lanes[e], width[e], bicycle[e], bicycle_safety[e], foot[e], foot_safety[e], \
                max_speed[e], motorcar[e] = osm_id[cu], highway[cu], level[cu], lanes[cu], width[cu], bicycle[cu], bicycle_safety[cu], \
    ...
    for candidate in candidates:
        ...
        if is_u_fringe and is_w_fringe:
            ...
            e_linestring[e] = [int(nodes_id[node]) for node in path]
            osm_id[e], highway[e], level[e], lanes[e], width[e], bicycle[e], bicycle_safety[e], foot[e], foot_safety[e], \
                max_speed[e], motorcar[e] = osm_id[uc], highway[uc], level[uc], lanes[uc], width[uc], bicycle[uc], bicycle_safety[uc], \
